...
Read the template name, page title, and any notes from the message that invoked this command. If any of those (or the screenshot) is missing, ask before proceeding rather than guessing.
