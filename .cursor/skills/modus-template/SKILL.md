...
name: modus-template
description: >-
  Procedural playbook for building a copy-paste Modus Web Components template page
  from a screenshot or design reference. Run after reading modus-template/REFERENCE.md
  (mandatory contract). Covers discovery, routing, responsive layout, quality bar,
  and completion summary. Load only when /modus-template runs.
disable-model-invocation: true
---

# Modus template — implementation playbook
