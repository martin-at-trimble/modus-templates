# Modus template — reference contract
...
Sibling copies: [.claude/skills/modus-template/REFERENCE.md](../../.claude/skills/modus-template/REFERENCE.md). Keep in sync with [.cursor/skills/modus-template/SKILL.md](./SKILL.md). Run `npm run check:modus-template-sync` after edits.
