...
argument-hint: <template name> | <page title> | [optional notes]
---
...
Parse `$ARGUMENTS` as pipe-separated: `<template name> | <page title> | [optional notes]`.
...
- **Optional notes:** anything the screenshot doesn't make obvious — everything after the second `|` (may be empty).
